...
vim.keymap.set('n', '<leader>e', ':NvimTreeToggle<CR>', {
    noremap = true,
    desc = 'Abre/cierra Nvim-tree'
})
vim.keymap.set('n', '<C-l>', '<c-w>w', {
    noremap = true,
    desc = 'Cambia de Nvim-tree al buffer actual'
})
vim.keymap.set('n', '<C-h>', '<c-w>w', {
    noremap = true,
    desc = 'Cambia del buffer actual al Nvim-tree'
})

-- Barbar buffers
vim.keymap.set('n', '<C-j>', ':BufferPrevious<CR>', {
    desc = 'Cambia al buffer previo'
})
vim.keymap.set('n', '<C-k>', ':BufferNext<CR>', {
    desc = 'Cambia al siguiente buffer'
})
vim.keymap.set("n", "<leader>cb", ":BufferClose<CR>", {
    desc = "[C]errar [b]uffer actual"
})

-- Illuminate keymap
vim.keymap.set('n', '<a-w>', require('illuminate').goto_next_reference, {
    desc = "Mueve el cursor a la siguiente referencia"
})
vim.keymap.set('n', '<a-b>', require('illuminate').goto_prev_reference, {
    desc = "Mueve el cursor a la referencia previa"
})
...
vim.keymap.set("n", "<leader>xx", "<cmd>TroubleToggle<cr>", {
    silent = true,
    noremap = true,
    desc = "Muestra la lista de errores"
})
vim.keymap.set("n", "<leader>xw", "<cmd>TroubleToggle workspace_diagnostics<cr>", {
    silent = true,
    noremap = true,
    desc = "Muestra errores del workspace"
})
vim.keymap.set("n", "<leader>xd", "<cmd>TroubleToggle document_diagnostics<cr>", {
    silent = true,
    noremap = true,
    desc = "Muestra errores del documento"
})
...
vim.keymap.set("n", "<leader>xq", "<cmd>TroubleToggle quickfix<cr>", {
    silent = true,
    noremap = true,
    desc = "Arreglos rápidos"
})
vim.keymap.set("n", "gR", "<cmd>TroubleToggle lsp_references<cr>", {
    silent = true,
    noremap = true,
    desc = "La lista de errores del LSP"
})
...
vim.keymap.set('n', '<leader>?', require('telescope.builtin').oldfiles, {
    desc = '[?] Busca archivos recientes'
})
vim.keymap.set('n', '<leader><space>', require('telescope.builtin').buffers, {
    desc = '[ ] Busca buffers abiertos'
})
...
vim.keymap.set('n', '[d', vim.diagnostic.goto_prev, {
    desc = "Previo diagnostico"
})
vim.keymap.set('n', ']d', vim.diagnostic.goto_next, {
    desc = "Siguiente diagnostico"
})
...
require("null-ls").setup({
    sources = { formatting.black, formatting.rustfmt, formatting.phpcsfixer, formatting.prettier.with({
        extra_filetypes = { "toml" },
        indent_size = { 4 }
    }), formatting.stylua, formatting.gofmt },
